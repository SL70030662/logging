...
public class HouseConstructionCost extends MaterialsRequiredToConstructHouse
{

	HouseConstructionCost(String materialType, double totalAreaOfHouse, String automationType) {
